...
?>
	...
	<div class="topnav">
		...
		<div class="dropdown" style="float:right">
			...
			<!-- drop down menu with user's first name -->
	...
	<body>
		...
		<section>
			<div class="home_box3">
				...
				<div class="gallery">
					<a target="_blank" href="images\SCOTT'S MOTs-logos.jpeg">
						<img src="images\SCOTT'S MOTs-logos.jpeg">
					</a>
				</div>
			</div>
		</section>
		...
		<footer> 
			...
			<div class = "products">
				...
				<!-- account page link is created if the user is signed in -->
